import 'dart:ui';
import 'package:Remind/TeacherScreen/Tea_side_menu.dart';
...
class _TeacherLoginScreenState extends State<TeacherLoginScreen> {
  ...
  void signUserIn() async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Tea_side_menu()),
      );
    } catch (e) {
  ...
  void submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (hasSignedUp) {
        ...
        sharedPreferences.setString('userType', 'teacher'); // Set user type as 'student'
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  if (hasSignedUp) {
                    final SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
                    sharedPreferences.setString('userType', 'teacher'); // Set user type as 'teacher'
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: ElevatedButton(
                    onPressed: submitForm, // Call the submitForm function
                    style: ElevatedButton.styleFrom(
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(40),
                      ),
