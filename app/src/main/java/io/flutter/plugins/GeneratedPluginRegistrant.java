...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new de.lotum.lottie_native.LottieNativePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin lottie_native, de.lotum.lottie_native.LottieNativePlugin", e);
    }
    try {
